...
```
![image](https://github.com/user-attachments/assets/46ce8e20-42e1-4805-b13a-027abc2110e5)
...
![image](https://github.com/user-attachments/assets/45b0f524-4365-44ca-a87b-4be844c940ba)
...
.header nav button:hover {
    background: hwb(54 44% 4%);
}

.sidebar {
    grid-area: sidebar;
    background: hsl(291, 98%, 67%);
    color: white;
    padding: 1.5rem;
    display: flex;
    flex-direction: column;
...
.stat-card {
    ...
    padding: 1.5rem;
    border-radius: 8px;
    box-shadow: 0 2px 4px rgba(255, 157, 217, 0.1);
    text-align: center;
}
...
```
[บันทึกภาพหน้าจอของผลลัพธ์การทดลอง]
![image](https://github.com/user-attachments/assets/5a719b89-3fcb-478d-af66-773efd3dc7c0)
